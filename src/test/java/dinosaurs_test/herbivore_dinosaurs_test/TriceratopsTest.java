...
public class TriceratopsTest {
    ...
    public void triceratopsHasDiscription() {
        assertEquals("With its 3 horns, a parrot-like beak and a large frill that could reach nearly 1 metre (3 feet) across, the Triceratops skull is one of the largest and most striking of any land animal.", triceratops.getDiscription());
    }
